export const articles = [
    ...
    {
        location: "La Fortuna",
        article: "Rio Celeste and Tenorio National Park",
        textBlocks: [
    ...
    {
        location: "La Fortuna",
        article: "Cozy Cabin in La Fortuna",
        textBlocks: [
    ...
    {
        location: "La Fortuna",
        article: "Lake Arenal Watersports",
        textBlocks: [
    ...
    },
    {
        ...
        textBlocks: [
            ...
            "As I arrived at the Zion Paragliding base, a sense of excitement mingled with more than a touch of nerves. The professional pilots welcomed me warmly, and their reassurances put me at ease. They explained the process – how we would need to run off the edge of a cliff for takeoff. My heart raced as I listened, and I couldn't help but wonder what the experience would be like.",
            ...
            "And then came the incredible surprise – the birds became our guides. They seemed to know where the thermals were, those invisible pockets of rising warm air that paragliders use to gain altitude. We followed their lead, allowing the birds to show us the way. With each ascent, the landscape transformed beneath us, and we found ourselves soaring up into the clouds.",
            ...
            "As our journey drew to a close, we began our descent towards the familiar beach below. The mountains gave way to the coastline, and the landing spot was the very same beach where I had run countless times during my stay in Dominical. The view from the sky was a revelation – the beach, the waves, the lush greenery – all transformed into a masterpiece painted by the gods themselves.",
            
            "Touching down on the sandy shore, I felt a rush of emotions – a mix of gratitude, exhilaration, and wonder. The sky had offered me a new perspective, a glimpse of a world where gravity was a mere suggestion and the horizon was mine to explore.",
