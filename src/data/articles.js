const articles = [
    ...
    },
    {
        ...
        textBlocks: [
            "As I arrived at the Zion Paragliding base, a sense of excitement mingled with more than a touch of nerves. The professional pilots welcomed me warmly, and their reassurances put me at ease. They explained the process – how we would need to run off the edge of a cliff for takeoff. I was literally about to follow my friend off a cliff, having watched him confidently run straight off, dip from the weight on his paragliding wing before the wind current lofted him higher. It was only because of how easy and graceful he made it look - the other pilots in training had called him 'angel' more than once, that I was standing here, unable to back down.",

            "My instructor and I took three steps together, and a gust of wind swept us off our feet before we could even reach the edge. The sensation was incredible – the ground dropped away, and suddenly, we were airborne. The initial rush of takeoff was followed by a feeling of weightlessness, a dance with the wind that was both surreal and mesmerizing.",

            "As we ascended into the sky, I couldn't help but notice that we weren't alone. Birds soared gracefully alongside us, as if welcoming us into their domain. It was a sight to behold – humans and birds sharing the same currents, connected by a shared sense of freedom.",
            
            "The other paragliders in the area  circled around a distant tower, like colorful specks against the vast expanse of blue. I marveled at how the pilots navigated the currents with such skill and grace, their movements a testament to their experience and love for the skies.",
            

            "Passing through a cloud was an experience beyond my imagination.  It was like stepping into a dream, a surreal interlude where time seemed to stand still.",
            
            "We touched down on the same sandy shore where I had run just that morning. The sky had offered me a new perspective, a glimpse of a world where gravity was a mere suggestion and the horizon was mine to explore.",
            
            "Zion Paragliding gave me not just an adventure but a chapter in the book of my life – a story of flight, of connection with nature, and of the beauty that exists when we dare to defy boundaries."
        ],
    ...
    },
    {
        ...
        textBlocks: [
            ...
            "Costa Rica is a land of breathtaking natural wonders, and Nauyaca Falls is undoubtedly one of its crown jewels, the tallest waterfall in Costa Rica. My solo adventure to Nauyaca Falls was aan opportunity to witness the power and beauty of nature up close.",
            ...
            "However, my adventure wasn't over yet. After relishing my time at the falls, I faced a new challenge—getting back to civilization. With no shuttle buses or taxis in sight, I was momentarily stuck. But as luck would have it, I had the foresight to bring my phone. A quick call to a friend, and a taxi was on its way to rescue me from my remote oasis.",
            
            "As I departed Nauyaca Falls in the comfort of the taxi, I couldn't help but reflect on the beauty of Costa Rica. It's a journey I'll cherish forever, reminding me that sometimes, the most remarkable adventures are the ones we undertake alone."
        ],
    ...
    },
    {
        ...
        textBlocks: [
            ...
            "We started with a quick introduction to surfing,the basics of ocean safety, and a rundown of the day's plan. Before even stepping into the water, I learned the proper paddling technique on the beach. Once in the shallows, my instructor guided me through the process of catching smaller, manageable waves.",
            
            "As my confidence grew, we ventured a little further into the ocean to tackle larger waves. Throughout the lesson, my instructor provided invaluable feedback and constant encouragement. Surfing can be challenging, but with their guidance, I felt a growing sense of achievement with each ride.", 
            ...
            "If you're looking for an unforgettable experience that combines the joy of surfing with the serenity of a tropical paradise, I can wholeheartedly recommend a surf lesson in Dominicalita. It's a journey of self-discovery and pure bliss that I'll carry with me forever. Pura Vida!"
        ],
